...
[Singleton]
public class LiveScripting(ILogger logger, IHarmony harmony) : ILiveScripting
{
    public Script NewScript()
    {
        var script = new Script(CoreModules.Preset_Complete)
        {
            ...
            {
                // TODO: help function
                // any `ref` args should just be returned from the lua function in a table
                // `__result = result`, `return true/false = return`
                // won't include ___fields in arg
                ["patch"] = (PatchDelegate)Patch
            }
        };
    ...
    private delegate void PatchDelegate(Script script, string target, Closure callback, string patchType = "Auto",
        string patchPoint = "Prefix", string[] args = null, string[] generics = null,
        bool declared = false);

    private void Patch(Script script, string target, Closure callback, string patchType = "Auto",
        string patchPoint = "Prefix", string[] args = null, string[] generics = null,
        bool declared = false)
    {
