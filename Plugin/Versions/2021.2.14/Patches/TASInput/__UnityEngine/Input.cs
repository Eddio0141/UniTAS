...
class GetKeyInt
{
    static bool Prefix(KeyCode key, ref bool __result)
    {
        ...
        {
            __result = Keyboard.Keys.Contains(Core.UnityHook.Types.InputLegacy.KeyCode.From(key));
...
class GetKeyUpInt
{
    static bool Prefix(KeyCode key, ref bool __result)
    {
        if (Core.TAS.Main.Running)
        {
            __result = Keyboard.KeysUp.Contains(Core.UnityHook.Types.InputLegacy.KeyCode.From(key));
...
class GetKeyDownInt
{
    static bool Prefix(KeyCode key, ref bool __result)
    {
        if (Core.TAS.Main.Running)
        {
            __result = Keyboard.KeysDown.Contains(Core.UnityHook.Types.InputLegacy.KeyCode.From(key));
