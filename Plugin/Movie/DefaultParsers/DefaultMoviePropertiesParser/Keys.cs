...
public partial class DefaultMoviePropertiesParser
{
    ...
    private class StartTimeKey : KeyBase
    {
    ...
    private class FrameTimeKey : KeyBase
    {
    ...
    private class ResolutionKey : KeyBase
    {
    ...
    private class Unfocused : KeyBase
    {
    ...
    private class FullScreen : KeyBase
    {
    ...
    private class FromSaveState : KeyBase
    {
    ...
    private class DescriptionKey : KeyBase
    {
    ...
    private class AuthorKey : KeyBase
    {
    ...
    private class EndSaveKey : KeyBase
    {
