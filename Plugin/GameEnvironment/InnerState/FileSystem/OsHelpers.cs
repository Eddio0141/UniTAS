...
public static class OsHelpers
{
    ...
    public static void OpenFile(string path, FileMode mode, FileAccess access, FileShare share, FileOptions options)
    {
        ...
        switch (mode)
        {
            ...
            case FileMode.Create:
            {
                ...
                var dir = OsFileSystems.FileSystem.CreateDir(pathDir.FullName);
            ...
            case FileMode.Append:
            {
                file = GetFile(path);
                if (file == null)
                    file = OsFileSystems.FileSystem
                        .CreateDir(Directory.GetParent(path).FullName).AddFile(Path.GetFileName(path));
    ...
    {
        OsFileSystems.FileSystem.DeleteFile(path);
    }
    ...
    {
        return OsFileSystems.FileSystem.FileExists(path);
    }

    public static bool DirectoryExists(string path)
    {
        return OsFileSystems.FileSystem.DirectoryExists(path);
    }
    ...
    {
        _ = OsFileSystems.FileSystem.CreateDir(path);
    }
